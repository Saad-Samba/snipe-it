<table
    ...
    <tr>
        ...
        <th data-field="qty" data-sortable="true" data-request-tooltip="Total quantity needed for this request."@if (!empty($showFooter)) data-footer-formatter="qtySumFormatter"@endif>Quantity</th>
        ...
        <th data-field="estimated_savings" data-sortable="true" data-formatter="requestSavingsFormatter" data-request-tooltip="The reference price used here is the one saved at the time of the request."@if (!empty($showFooter)) data-footer-formatter="sumFormatter"@endif>Estimated Savings</th>
