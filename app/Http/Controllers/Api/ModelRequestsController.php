...
class ModelRequestsController extends Controller
{
    public function index(Request $request): array
    {
        ...
        foreach ($checkoutRequests as $checkoutRequest) {
            ...
            $requestAssetBucketBaseQuery = ['request_id' => $checkoutRequest->id];
            $requestDetailUrl = $isLicenseRequest
                ? route('licenses.index', ['request_id' => $checkoutRequest->id, 'license_id' => $checkoutRequest->requestable_id])
                : route('hardware.index', ['request_id' => $checkoutRequest->id, 'request_bucket' => 'reusable_now']);

            $assets = [
                'request_id' => (int) $checkoutRequest->id,
                'image' => $isLicenseRequest ? null : e($checkoutRequest->itemRequested()->present()->getImageUrl()),
                ...
                'requested_for_type' => $checkoutRequest->requested_for_type,
                'requested_for_display' => e((string) $checkoutRequest->requested_for_display),
                ...
                'expected_release_before_needed_by_quantity' => (int) ($liveMetrics['due_back_before_needed_by_quantity'] ?? 0),
                ...
                'total_need_cost_formatted' => $checkoutRequest->reference_price_snapshot !== null
                    ...
                    : null,
                'reserved_count' => $isLicenseRequest ? null : $checkoutRequest->reservedAssetsCount(),
                'reserved_by_other_rfqs_count' => $isLicenseRequest ? null : $checkoutRequest->reservedByOtherRfqsCount(),
                ...
                'expected_checkin' => $isLicenseRequest ? null : Helper::getFormattedDateObject($checkoutRequest->itemRequested()->expected_checkin, 'datetime'),
