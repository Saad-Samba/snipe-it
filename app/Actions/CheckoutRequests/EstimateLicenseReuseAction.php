...
class EstimateLicenseReuseAction
{
    public static function run(License $license, int $requestedQuantity, ?string $neededByDate = null): array
    {
        ...
        $unitPrice = $license->unitPurchaseCost();
        ...
        return [
            ...
            'estimated_savings' => round($coverableQuantity * $unitPrice, 2),
            'reference_price_snapshot' => $license->purchase_cost !== null ? $unitPrice : null,
        ];
    }
}
