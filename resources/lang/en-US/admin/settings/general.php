...
return [
    ...
    'admin_cc_email_help'       => 'Send a copy of assignment and return emails to this address.',
    'admin_cc_always' => 'Always send a copy upon assignment and return',
    'admin_cc_when_acceptance_required' => 'Only send a copy upon assignment if acceptance is required',
    ...
    'asset_ids'					=> 'Asset IDs',
    'audit_interval'            => 'Asset Verification Interval',
    'audit_interval_help'       => 'Enter how often assets must be physically verified, in months. Updating this value recalculates upcoming verification due dates.',
    'audit_warning_days'        => 'Verification Warning Threshold',
    'audit_warning_days_help'   => 'How many days in advance should assets due for verification be shown?',
    ...
    'display_checkout_date'     => 'Display Assignment Date',
    ...
    'login_note_placeholder'            => "If you do not have a login or have found a device belonging to this organization, please call technical support at 888-555-1212. Thank you.",
    ...
    'full_multiple_companies_support_help_text' => 'Restrict users, including administrators, to assets associated with their site.',
    'full_multiple_companies_support_text' => 'Full Multiple Site Support',
    'scope_locations_fmcs_support_text'  => 'Scope Locations with Full Multiple Site Support',
    'scope_locations_fmcs_support_help_text'  => 'Restrict locations to their selected site.',
    ...
    'require_checkinout_notes'  => 'Require Notes on Assignment/Return',
    'require_checkinout_notes_help_text'    => 'Require assignment and return note fields to be completed for assets.',
    'rfq_reserved_status' => 'RFQ Reservation Status',
    'rfq_reserved_status_help' => 'The deployable status selected by default when a RAC assigns reusable inventory for a request. Auto-detect uses a status named exactly "Reserved for RFQ" when one exists.',
    'rfq_reserved_status_none' => 'Auto-detect "Reserved for RFQ"',
    'left'        => 'left',
    'right'        => 'right',
    'top'        => 'top',
    'bottom'        => 'bottom',
    ...
    'notifications_help' => 'Email Alerts & Asset Verification Settings',
    ...
    'label2_title_help_phold' => 'The placeholder <code>{COMPANY}</code> will be replaced with the asset&apos;s site name',
    'label2_asset_logo'       => 'Use Asset Logo',
    'label2_asset_logo_help'  => 'Use the logo of the asset&apos;s assigned site rather than the value at <code>:setting_name</code>',
    ...
    'due_checkin_days' => 'Due for Return Warning',
    'due_checkin_days_help' => 'How many days before an asset\'s expected return date should it appear on the "Due for Return" page?',
    ...
    'keywords' => [
        ...
        'general_settings'  => 'site support, signature, acceptance, email format, username format, images, per page, thumbnail, eula, gravatar, tos, dashboard, privacy',
