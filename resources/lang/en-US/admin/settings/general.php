...
return [
    ...
    'rfq_reserved_status_help' => 'The deployable status selected by default when a RAC checks out reusable inventory for a request. Auto-detect uses a status named exactly "Reserved for RFQ" when one exists.',
