<table
    ...
    <tr>
        ...
        <th data-field="requested_for_display" data-sortable="true">Assignee</th>
        ...
        <th data-field="due_back_before_needed_by_quantity" data-sortable="true" data-formatter="requestDueBackFormatter" data-request-tooltip="For assets, this is due back before needed-by. For licenses, this is the informational expected-release count before needed-by.">Expected / Due Back</th>
