...
<script nonce="{{ csrf_token() }}">
    ...
    function ensureModelRequestCartModal() {
        ...
        var modalHtml = ''
            ...
            + '            <div class="col-md-6">'
            + '              <div class="form-group">'
            + '                <label for="model-request-cart-project">{{ trans('general.project') }} <span class="label label-info" data-tooltip="true" title="Recently released feature">NEW</span></label>'
            + '                <div class="input-group">'
            ...
            + '            <div class="col-md-6">'
            + '              <div class="form-group">'
            + '                <label for="model-request-cart-needed-by-date">Needed By <span class="label label-info" data-tooltip="true" title="Recently released feature">NEW</span></label>'
            ...
            + '            <div style="font-weight:600;margin-bottom:8px;">Reuse Planning Totals <span class="label label-info" data-tooltip="true" title="Recently released feature">NEW</span></div>'
            + '            <div style="display:grid;grid-template-columns:auto 1fr;column-gap:12px;row-gap:6px;">'
