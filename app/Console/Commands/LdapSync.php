...
class LdapSync extends Command
{
    ...
    public function handle()
    {
        ...
        // Users with assigned inventory or management relationships are skipped.
        if ($this->option('delete')) {
            $missing_ldap_users = User::where('ldap_import', 1)
                ->whereNotIn('username', $seen_ldap_usernames)
                ->get();
    ...
    /**
     * Determine whether a user can be deleted without applying an authorization gate.
     */
