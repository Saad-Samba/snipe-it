...
if [ ! -L "/var/www/html/storage/private_uploads" ]; then
...
if [ ! -L "/var/www/html/storage/app/backups" ]; then
...
if [ ! -L "/var/www/html/storage/oauth-private.key" ]; then
  ln -fs "/var/lib/snipeit/keys/oauth-private.key" "/var/www/html/storage/oauth-private.key"
fi

if [ ! -L "/var/www/html/storage/oauth-public.key" ]; then
...
chown -hR apache:root /var/www/html/storage/
chown -R apache:root /var/www/html/storage/framework/cache
chown -R apache:apache /var/www/html/bootstrap/cache

# Install/update composer dependencies at runtime (since code is mounted as volume)
