...
return [
    ...
    'show_in_email'     => 'Include this field in assignment emails sent to the user? Encrypted fields cannot be included in emails.',
    ...
    'unique' => 'Unique',
    'display_in_user_view' => 'Allow the assigned user to view these values on their View Assigned Assets page',
    ...
    'display_checkin' => 'Display in return forms',
    'display_checkout' => 'Display in assignment forms',
    'display_audit' => 'Display in asset verification forms',
    'types' => [
        'text' => 'Text Box',
        'listbox' => 'List Box',
