                        ...
                        <div class="form-group {{ $errors->has('asset_tag') ? 'error' : '' }}">
                            ...
                            <div class="col-md-9">
                                <div class="input-group date col-md-11 required" data-date-format="yyyy-mm-dd">
                                    <input type="text" class="form-control" name="asset_tag" id="asset_tag" aria-describedby="asset_tag_help" required value="{{ old('asset_tag') }}">

                                </div>
                                <p class="help-block" id="asset_tag_help">{{ trans('general.bulk_audit_tag_help') }}</p>
