...
return [
    ...
    'current_assets'    => 'Assets currently assigned to this user',
    'transfer_assets'   => 'Transfer Assets',
    'transfer_to_user'  => 'Transfer to',
    'transfer_assets_help' => 'Selected assets will be returned from this user and immediately assigned to the chosen user.',
    'transfer_default_location_help' => 'Leave blank to keep the asset\'s default location unchanged. Its current location will follow the recipient.',
    'bulk_checkin_assets' => 'Return All Assets',
    'clone'             => 'Clone User',
    ...
    'software_user'     => 'Software Assigned to :name',
    ...
    'warning_deletion_information' => 'You are about to return ALL items from the :count user(s) listed below. Super admin names are highlighted in red.',
    'update_user_assets_status' => 'Update all assets for these users to this status',
    'checkin_user_properties' => 'Return all items associated with these users',
    ...
    'rac_enabled_help' => 'When enabled, the user becomes the responsible coordinator for the selected disciplines within their site.',
