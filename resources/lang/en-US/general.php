...
return [
    ...
    'audit'				    => 'Verify Asset',
    'audited'				=> 'Verified',
    'audits'				=> 'Asset Verifications',
    'audit_report'			=> 'Asset Verification History',
    'assets'				=> 'Assets',
    'assigned_assets'       => 'Assigned Assets',
    'filter_all_to_assigned' => 'Click to show assigned only.',
    'filter_all_to_unassigned' => 'Click to show unassigned only.',
    'filter_assigned_to_all' => 'Filtering assigned only. Click to show all items.',
    'filter_unassigned_to_all' => 'Filtering unassigned only. Click to show all items.',
    'owned_assets'          => 'Owned Assets',
    'assets_audited'        => 'assets verified',
    'assets_checked_in_count'     => 'assets returned',
    'assets_checked_out_count'     => 'assets assigned',
    ...
    'bulkaudit'             => 'Verify Multiple Assets',
    'bulkaudit_status'      => 'Verification Status',
    'bulk_audit_tag_help'   => 'Scan or enter one asset tag at a time, then select Verify Asset. Repeat for each asset; results are added to the Verification Status list.',
    'bulk_checkout'  		=> 'Assign Multiple Assets',
    'bulk_edit'             => 'Bulk Edit',
    'bulk_delete'           => 'Bulk Delete',
    'bulk_actions'          => 'Bulk Actions',
    'bulk_checkin_delete'   => 'Return All / Delete Users',
    'byod'                  => 'BYOD',
    ...
    'checkin'  				=> 'Return',
    'checkin_from'  		=> 'Return from',
    'checkin_note'  		=> 'Return Note',
    'checkout_note'  		=> 'Assignment Note',
    'checkout'  			=> 'Assign',
    'assign_to_user'        => 'Assign to User',
    'assign_to_asset'       => 'Assign to Asset',
    'assign_to_location'    => 'Assign to Location',
    'assign_to'             => 'Assign To',
    ...
    'expected_return_date_range' => 'Expected Return Date Range',
    ...
    'days'      			=> 'days',
    'days_to_next_audit'    => 'Days Until Next Verification',
    'date'					=> 'Date',
    ...
    'next'					=> 'Next',
    'next_audit_date'		=> 'Next Verification Due Date',
    'next_audit_date_help'  => 'If your organization regularly verifies assets, this is usually calculated automatically from the asset&apos;s last verification date and verification interval (in <code>Admin Settings &gt; Alerts</code>). You can leave this blank, or set it manually to a date later than the last verification date.',
    'audit_images_help'     => 'You can find verification images in the asset\'s history tab.',
    'no_email'              => 'No email address associated with this user',
    'last_audit'		    => 'Last Verification Date',
    'last_verification_date_range' => 'Last Verification Date Range',
    'next_verification_due_date_range' => 'Next Verification Due Date Range',
    'new'					=> 'new!',
    ...
    'quickscan_checkin'  	=> 'Quick Scan Return',
    'quickscan_checkin_status'  	=> 'Return Status',
    'ready_to_deploy'		=> 'Ready to Deploy',
    'recent_activity'		=> 'Recent Activity',
    'remaining'             => 'Remaining',
    'remove_company'        => 'Remove Site Association',
    'reports'				=> 'Reports',
    'restored'				=> 'restored',
    'restore'				=> 'Restore',
    ...
    'assigned_in_use'       => 'Assigned / In Use',
    'flags'                 => 'Flags',
    ...
    'audit_due'             => 'Due for Verification',
    'audit_due_days'        => '{}Assets Due or Overdue for Verification|[1]Assets Due or Overdue for Verification Within a Day|[2,*]Assets Due or Overdue for Verification Within :days Days',
    'audit_due_days_view_all' => '{}Assets Due or Overdue for Verification|[1]View All Assets Due or Overdue for Verification Within a Day|[2,*]View All Assets Due or Overdue for Verification Within :days Days',
    'checkin_due'           => 'Due for Return',
    'checkin_overdue'       => 'Overdue for Return',
    'checkin_due_days'      => '{}Due for Return|[1]Assets Due for Return Within :days Day|[2,*]Assets Due for Return Within :days Days',
    'audit_overdue'         => 'Overdue for Verification',
    'accept'                => 'Accept :asset',
    'i_accept'              => 'I accept',
    ...
    'fields'                => 'Fields',
    'last_checkout'         => 'Last Assignment Date',
    'due_to_checkin'        => 'The following :count items are due for return soon:',
    'expected_checkin'      => 'Expected Return Date',
    'reminder_checked_out_items' => 'This is a reminder of the items currently assigned to you. If this list is inaccurate, email :reply_to_name at :reply_to_address.',
    'changed'               => 'Changed',
    'to'                    => 'To',
    'to_user'               => 'To',
    ...
    'invalid_item_category_single' => 'Invalid or missing :type category. Update the category of this :type before assigning it.',
    ...
    'checkout_tooltip' => 'Assign this item',
    'checkin_tooltip' => 'Return this item so it is available for reassignment, re-imaging, etc.',
    'checkout_user_tooltip' => 'Assign this item to a user',
    'checkin_to_diff_location' => 'You can return this asset to a location other than its default location of :default_location, if one is set.',
    ...
    'bulk_checkin_delete_success' => 'Your selected users have been deleted and their items have been returned.',
    'bulk_checkin_success' => 'The items for the selected users have been returned.',
    ...
    'clear_expected_return_date' => 'Clear Expected Return Date',
    'clear_next_verification_due_date' => 'Clear Next Verification Due Date',
    'clear_site'            => 'Clear Site',
    ...
    'autoassign_licenses_help_long' => 'Allows a user to receive licenses through bulk assignment in the UI or CLI. For example, you may exclude contractors from automatic assignment while still assigning licenses to them individually.',
    ...
    'undeployable_tooltip'      => 'This item cannot be assigned. Check the quantity remaining.',
    'serial_number'        => 'Serial Number',
    'item_notes' => ':item Notes',
    'item_name_var' => ':item Name',
    'error_user_company' => 'The assignment target site and asset site do not match',
    'error_user_company_multiple' => 'One or more assignment target sites and asset sites do not match',
    'error_user_company_accept_view' => 'An asset assigned to you belongs to a different site, so you cannot accept or decline it. Please check with your manager.',
    'error_assets_already_checked_out' => 'One or more of the assets are already assigned',
    'assigned_assets_removed' => 'The following were removed from the selected assets because they are already assigned',
    'importer' => [
        'checked_out_to_fullname' => 'Assigned To: Full Name',
        'checked_out_to_first_name' => 'Assigned To: First Name',
        'checked_out_to_last_name' => 'Assigned To: Last Name',
        'checked_out_to_username' => 'Assigned To: Username',
        'checked_out_to_email' => 'Assigned To: Email',
        'checked_out_to_tag' => 'Assigned To: Asset Tag',
        'manager_first_name' => 'Manager First Name',
        'manager_last_name' => 'Manager Last Name',
        'manager_full_name' => 'Manager Full Name',
        'manager_username' => 'Manager Username',
        'manager_employee_num' => 'Manager Employee Number',
        'checkout_type' => 'Assignment Type',
        'checkout_location' => 'Assign to Location',
    ...
    'checked_out_to_fields' => 'Assigned To Fields',
    ...
    'rtd_location_help' => 'This is the asset\'s default location when it is not assigned',
    ...
    'more_info' => 'More Info',
    'quickscan_bulk_help' => 'Checking this box updates the asset\'s current location. Leaving it unchecked records the location only in the asset verification history. If the asset is assigned, it will not change the location of the user, asset, or location it is assigned to.',
    'whoops' => 'Whoops!',
...
// Add form placeholders here
    ...
    'breadcrumb_button_actions' => [
        'edit_item' => 'Edit :name',
        'checkout_item' => 'Assign :name',
        'checkin_item' => 'Return :name',
    ],
