        ...
        <form class="form-horizontal" method="post" action="" autocomplete="off">
            ...
            <div class="box box-default">
                ...
                <div class="box-body">
                    ...
                    @include ('partials.forms.edit.user-select', ['translated_name' => trans('general.assign_to_user'), 'fieldname' => 'assigned_to', 'style' => (session('checkout_to_type') ?: 'user') == 'user' ? '' : 'display: none;'])
                    @include ('partials.forms.edit.asset-select', ['translated_name' => trans('general.assign_to_asset'), 'fieldname' => 'asset_id', 'style' => session('checkout_to_type') == 'asset' ? '' : 'display: none;'])
                ...
                <x-redirect_submit_options
                        ...
                        :button_label="trans('admin/licenses/general.checkout')"
                        :options="[
