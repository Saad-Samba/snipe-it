...
return [
    ...
    'rac_request_scope_match_intro' => 'Reusable stock was detected in your scope for the request below. Please review it in Snipe-IT so the requester is not left waiting.',
    'rac_request_scope_match_action' => 'Please open the request in Snipe-IT and decide how to act on the reusable stock shown below.',
    'rac_request_scope_match_cta' => 'Review request in Snipe-IT',
    ...
    'rac_request_scope_match_reminder_intro' => 'This is a reminder that the reuse request below is still waiting for your review in Snipe-IT.',
    'rac_request_scope_match_reminder_action' => 'Please review the open request lines below in Snipe-IT and take action if reusable stock is available in your scope.',
    'rac_request_scope_match_reminder_cta' => 'Review open requests in Snipe-IT',
